...
const conceptIcons: Record<string, () => JSX.Element> = {
  ...
  ego: () => (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
      <path d="M50 20 L80 70 L20 70 Z" fill="none" stroke="currentColor" strokeWidth="2"/>
      <circle cx="50" cy="50" r="5" fill="currentColor"/>
    </svg>
  ),
  persona: () => (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
      <path d="M50 20 Q30 30 30 50 T50 80 Q70 70 70 50 T50 20" fill="none" stroke="currentColor" strokeWidth="2"/>
  ...
  shadow: () => (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
      <rect x="30" y="30" width="40" height="40" fill="currentColor" opacity="0.3"/>
      <rect x="40" y="40" width="40" height="40" fill="none" stroke="currentColor" strokeWidth="2"/>
    </svg>
  ),
  'anima-animus': () => (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
      <circle cx="40" cy="50" r="25" fill="none" stroke="currentColor" strokeWidth="2"/>
      <circle cx="60" cy="50" r="25" fill="none" stroke="currentColor" strokeWidth="2" strokeDasharray="5,5"/>
    </svg>
  ),
  self: () => (
    <svg viewBox="0 0 100 100" className="w-32 h-32">
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-neutral-900/50 to-neutral-950">
      <div className="max-w-4xl mx-auto text-center">
        <div className={`flex justify-center mb-8 ${iconColorClass} animate-float`}>
          {Icon && <Icon />}
        </div>
